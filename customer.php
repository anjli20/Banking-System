...
<section id="nav-bar">
    ...
    <a href="history.php"><button type="button" id="btt">Transfered History</button></a>

    <table>
    <tr><th colspan=4><h2 style="padding-bottom:20px;">Customer Records</h2></th></tr>
        <tr><th>Sr.No.</th>
             <th>Name</th>
            <th>Email</th>
            <th>Mobile No.</th>
...
{               ?>                                        
        <tr>
            <td> &emsp;<?php echo htmlentities($cnt);?></td>
            <td>&emsp;&emsp;&emsp;<?php  echo htmlentities($row->name);?></td>
             <td>&emsp;&emsp;&emsp;&emsp;&emsp;<?php  echo htmlentities($row->email);?></td>
             <td>&emsp;&emsp;&emsp;&emsp;&emsp;<?php  echo htmlentities($row->mobile);?></td>                                     
        </tr><br>
       <?php $cnt=$cnt+1;}} ?> 
 </table>
</center>                         
